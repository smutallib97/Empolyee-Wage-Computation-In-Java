...
public class EmployeeWageComputation2 {
    ...
    EmployeeWageComputation2(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs) {
    ...
    public static void main(String args[]) {
        EmployeeWageComputation2 google = new EmployeeWageComputation2("Google", 8, 20, 100);
        EmployeeWageComputation2 microsoft = new EmployeeWageComputation2("Microsoft", 4, 30, 150);
